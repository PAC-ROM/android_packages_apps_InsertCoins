...
package com.pacrom.insertcoins.util;

import android.os.Bundle;
import android.os.UserManager;
import com.pacrom.insertcoins.InsertCoins;
import com.pacrom.insertcoins.R;
import com.pacrom.insertcoins.ui.WebViewDialogFragment;
...
public class InsertCoinsUtils {

    private static final String TAG = InsertCoinsUtils.class.getSimpleName();
    ...
    public static void launchWifiSetup(Activity context) {
        InsertCoinsUtils.tryEnablingWifi(context);
