...
public class LocalePicker extends LinearLayout {
    ...
    public LocalePicker(Context context, AttributeSet attrs, int defStyle) {
        ...
        SELECTOR_WHEEL_ITEM_COUNT = context.getResources().getInteger(com.pacrom.insertcoins.R.integer.local_picker_items);
        SELECTOR_MIDDLE_ITEM_INDEX = context.getResources().getInteger(com.pacrom.insertcoins.R.integer.local_picker_items)/2;
